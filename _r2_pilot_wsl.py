"""R2 pilot (WSL2): 2000 epochs of official HRM on Sudoku-Extreme 1K.

Deviations from official:
  - AdamW instead of adam_atan2
  - SDPA instead of flash_attn (patched in layers.py)
  - TF32 enabled
  - torch.compile enabled (Triton/Inductor backend)
  - WANDB offline
"""
...
EVAL_INTERVAL = 2000
BATCH_SIZE = 384
CHECKPOINT_DIR = '/mnt/e/Github/HRM-official/checkpoints/r2_pilot'
...
print(f'TF32: enabled, torch.compile: enabled (inductor)', flush=True)
